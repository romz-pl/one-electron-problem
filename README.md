...
- Cosine Periodic potential
- Deng–Fan Shifted potential
...
- Hyperbolic-cosh potential
- Hyperbolic double-well potential
- Hyperbolic Razavy-type potential
- Inverse-square potential
- Inverse-power Generalized potential
- [Kratzer potential](./doc/potential-kratzer.md)
- Kratzer Modified potential
- Kronig–Penney delta-comb potential
- Kronig–Penney + harmonic confinement
- Lamé potential
...
- Triple-well polynomial potential
- Varshni potentia
- Volcano potential
...
- [Quartic double well potential](./doc/applications-quartic-double-well.md)
...
- [Gaussian potential](./doc/numerical-gaussian.md)
